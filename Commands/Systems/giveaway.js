...
module.exports = {
    name: "giveaway",
    description: "Make Giveaways and edit them!",
    usage: "/giveaway [start/actions]",
    ...
    execute(interaction, client) {
        ...
        switch(Sub) {
            ...
            case "actions": {
                ...
                if (!giveaway) {
                    errorEmbed.setDescription(`Unable to find Giveaway with the message id :  ${messageId} in this server.`)
                    return interaction.reply({embeds : [errorEmbed], ephemeral: true})
                }
